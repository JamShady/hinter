...
var w = (n, e, s) => e in n ? d(n, e, { enumerable: !0, configurable: !0, writable: !0, value: s }) : n[e] = s;
var m = (n, e, s) => (w(n, typeof e != "symbol" ? e + "" : e, s), s);
class x {
  keywordRegex(e) {
    return "\\s*(?:" + e.join(":?|") + ":?)\\s+";
  }
...
class b {
  constructor() {
     ...
     * 'foo bar' => ['foo','bar']
     */
    m(this, "hints", (e) => e.replace(/\*/g, "").trim().split(/\s+/).map((s) => s.trim()).filter((s, r, t) => t.indexOf(s) === r));
    /**
     * foo(-bar)? => foo(-bar|)
     */
